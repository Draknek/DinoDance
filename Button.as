package
{
	...
	public class Button extends Sprite
	{
		...
		public function Button (_text: String, _textSize: Number = 16, _width: Number = 0, _colour: int = 0xcee3f8)
		{
			...
			addEventListener(MouseEvent.ROLL_OVER, function (param: * = 0) : void {textField.textColor = on});
			addEventListener(MouseEvent.ROLL_OUT, function (param: * = 0) : void {textField.textColor = off});
		}
